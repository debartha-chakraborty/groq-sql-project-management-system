...
def assign_task_availability(suited_employees_tasks):
    ...
    print('All Employees Project Count Matrix:',employees_project_count)
...
def ai_task_assigner():
    ...
    # print(colored("\n Test Results:", 'yellow'))
    # print(colored("\n\nEmployee and Suited Tasks Recommendation Results(AI generated): ", 'red'), colored(suited_employees_tasks, 'light_magenta'))
    # print(colored("\n\nEmployee and Task Assignment results Based on availability(Algorithmic): ", 'blue'),colored(assignment_matrix, 'light_cyan'))
    # print(colored("\n\nTasks and their Emtimated Time from the Ticket description(AI generated):",'red'), colored(task_details, 'light_magenta'))
    # print(colored("\n\nList of tuples that is generated by combining both AIs answers(Algorithmic): ", 'blue'), colored(final_output, 'light_cyan'))
    # print(colored("\n\nFinal Generated SQL:", 'green'), colored(sql, 'light_green'))
